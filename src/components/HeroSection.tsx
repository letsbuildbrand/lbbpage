    ...
    <section id="home" className="relative z-10 min-h-screen flex flex-col items-center justify-center text-center p-4 sm:p-8 pt-24">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-center mb-6">
          <Wrench className="h-16 w-16 text-yellow-500 mr-4 animate-bounce" />
          <h1 className="text-5xl sm:text-7xl font-extrabold tracking-tight text-white leading-tight">
            Your Agency Name
          </h1>
        </div>
        <p className="text-xl sm:text-3xl text-gray-300 mb-8 font-light">
        ...
        <Button size="lg" className="bg-yellow-500 hover:bg-yellow-600 text-gray-900 text-lg sm:text-xl px-8 py-6 rounded-full shadow-lg transition-all duration-300 transform hover:scale-105">
